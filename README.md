...
## 템플릿 메서드 패턴
템플릿 메서드 패턴은 이름 그대로 템플릿을 사용하는 방식이다.<br/>
템플릿은 기준이 되는 거대한 틀이다.<br/>
템플릿이라는 틀에 변하지 않는 부분을 몰아둔다.<br/>
변하는 부분은 자식 클래스를 만들어서 상속과 오버라이딩을 사용해서 처리한다.<br/>
<br/>
